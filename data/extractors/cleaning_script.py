...
def dateFormat(text):
    ...
    if text_split[0] == "Hoy,":
        ...
        return "11/06/20"
    elif text_split[0] == "Lunes" or text_split[0] == "Martes" or text_split[0] == "Miércoles" or text_split[
        0] == "Jueves" or text_split[0] == "Viernes" or text_split[0] == "Sábado" or text_split[0] == "Domingo":
...
>>>>>>> cf2e271a457fdc56e547bfb82fb2bc6bd95412a7:cleaning_script.py
