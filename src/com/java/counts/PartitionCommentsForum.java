 ...
 * @author Aidan
 */
public class PartitionCommentsForum {
    ...
    public static class CountWordsMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context output)
            ...
            if (value.toString().contains("post_theme") && value.toString().contains("date")) {
                ...
                if (parsedDate.isAfter(LocalDate.parse("18-10-2019",formatter))) {
                    for (String rawWord : comment_words) {
                        if(!rawWord.isEmpty()){
                            word.set(date_raw);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: "+ PartitionForum.class.getName()+" <in> <out>");
            System.exit(2);
        }
        ...
        job.setJarByClass(PartitionForum.class);
