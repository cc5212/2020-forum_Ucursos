 ...
 * @author Aidan
 */
public class CountWordsAfter18OBeforeCovid {
	...
	public static class CountWordsMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context output)
            ...
            if (value.toString().contains("post_theme") && value.toString().contains("date")) {
                ...
                if (parsedDate.isAfter(LocalDate.parse("18-10-2019",formatter)) && parsedDate.isBefore(LocalDate.parse("10-03-2020",formatter))) {
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 2) {
			System.err.println("Usage: "+ CountWordsAfter18OBeforeCovid.class.getName()+" <in> <out>");
			System.exit(2);
		}
	    ...
	    job.setJarByClass(CountWordsAfter18OBeforeCovid.class);
